...
class VehicleDlt(DeleteView):
    model = Vehicle
    success_url = reverse_lazy('shop:vehicle')
...
class TechnicianDlt(DeleteView):
    model = Technician
    success_url = reverse_lazy('shop:technician')
...
class SupplierDlt(DeleteView):
    model = Supplier
    success_url = reverse_lazy('shop:supplier')
...
class JobsDlt(DeleteView):
    model = Job
    success_url = reverse_lazy('shop:jobs')
...
class PartsDlt(DeleteView):
    model = Parts
    success_url = reverse_lazy('shop:parts')
